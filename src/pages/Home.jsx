    ...
    return (
        <>
            ...
            <section className='text-center container mx-auto py-10 lg:space-y-4 space-y-6 px-8'>
                <h2 className='font-ojuju md:text-4xl sm:text-3xl text-2xl font-bold text-indigo-700 dark:text-white'>
